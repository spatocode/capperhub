...
from core.views import UserAPIView, UserSubscriptionModelViewSet, UserWalletAPIView, UserPricingAPIView, PlayAPIView, P2PBetAPIView
...
urlpatterns = [
    ...
    path('bet', P2PBetAPIView.as_view(), name='bet'),
